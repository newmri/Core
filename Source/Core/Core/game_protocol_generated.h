...
struct SC_ITEM_INVENTORY_INFO_NOTI;
struct SC_ITEM_INVENTORY_INFO_NOTIBuilder;
struct SC_ITEM_INVENTORY_INFO_NOTIT;
...
struct CS_EQUIP_GEAR_REQ;
struct CS_EQUIP_GEAR_REQBuilder;
struct CS_EQUIP_GEAR_REQT;

struct SC_EQUIP_GEAR_RES;
struct SC_EQUIP_GEAR_RESBuilder;
struct SC_EQUIP_GEAR_REST;
...
enum Packet : uint8_t {
  ...
  Packet_SC_ITEM_INVENTORY_INFO_NOTI = 3,
  Packet_SC_PING_REQ = 4,
  Packet_CS_PING_RES = 5,
  Packet_CS_LOGOUT_NOTI = 6,
  Packet_SC_SPAWN_PLAYER_NOTI = 7,
  Packet_SC_DESPAWN_OBJECT_NOTI = 8,
  Packet_CS_MOVE_REQ = 9,
  Packet_SC_MOVE_RES = 10,
  Packet_CS_SET_STATE_REQ = 11,
  Packet_SC_SET_STATE_RES = 12,
  Packet_CS_USE_SKILL_REQ = 13,
  Packet_SC_USE_SKILL_RES = 14,
  Packet_SC_GET_DAMAGE_NOTI = 15,
  Packet_CS_REVIVE_REQ = 16,
  Packet_SC_REVIVE_RES = 17,
  Packet_SC_SPAWN_PROJECTILE_NOTI = 18,
  Packet_CS_EQUIP_GEAR_REQ = 19,
  Packet_SC_EQUIP_GEAR_RES = 20,
...
inline const Packet (&EnumValuesPacket())[34] {
  static const Packet values[] = {
    ...
    Packet_CS_LOGIN_REQ,
    Packet_SC_LOGIN_RES,
    Packet_SC_ITEM_INVENTORY_INFO_NOTI,
    Packet_SC_PING_REQ,
    Packet_CS_PING_RES,
...
template<> struct PacketTraits<GamePacket::SC_ITEM_INVENTORY_INFO_NOTI> {
  static const Packet enum_value = Packet_SC_ITEM_INVENTORY_INFO_NOTI;
};
...
template<> struct PacketTraits<GamePacket::CS_EQUIP_GEAR_REQ> {
  static const Packet enum_value = Packet_CS_EQUIP_GEAR_REQ;
};

template<> struct PacketTraits<GamePacket::SC_EQUIP_GEAR_RES> {
  static const Packet enum_value = Packet_SC_EQUIP_GEAR_RES;
};
...
struct PacketUnion {
  ...
  GamePacket::SC_ITEM_INVENTORY_INFO_NOTIT *AsSC_ITEM_INVENTORY_INFO_NOTI() {
    return type == Packet_SC_ITEM_INVENTORY_INFO_NOTI ?
      reinterpret_cast<GamePacket::SC_ITEM_INVENTORY_INFO_NOTIT *>(value) : nullptr;
  }
  const GamePacket::SC_ITEM_INVENTORY_INFO_NOTIT *AsSC_ITEM_INVENTORY_INFO_NOTI() const {
    return type == Packet_SC_ITEM_INVENTORY_INFO_NOTI ?
      reinterpret_cast<const GamePacket::SC_ITEM_INVENTORY_INFO_NOTIT *>(value) : nullptr;
  }
  ...
  GamePacket::CS_EQUIP_GEAR_REQT *AsCS_EQUIP_GEAR_REQ() {
    return type == Packet_CS_EQUIP_GEAR_REQ ?
      reinterpret_cast<GamePacket::CS_EQUIP_GEAR_REQT *>(value) : nullptr;
  }
  const GamePacket::CS_EQUIP_GEAR_REQT *AsCS_EQUIP_GEAR_REQ() const {
    return type == Packet_CS_EQUIP_GEAR_REQ ?
      reinterpret_cast<const GamePacket::CS_EQUIP_GEAR_REQT *>(value) : nullptr;
  }
  GamePacket::SC_EQUIP_GEAR_REST *AsSC_EQUIP_GEAR_RES() {
    return type == Packet_SC_EQUIP_GEAR_RES ?
      reinterpret_cast<GamePacket::SC_EQUIP_GEAR_REST *>(value) : nullptr;
  }
  const GamePacket::SC_EQUIP_GEAR_REST *AsSC_EQUIP_GEAR_RES() const {
    return type == Packet_SC_EQUIP_GEAR_RES ?
      reinterpret_cast<const GamePacket::SC_EQUIP_GEAR_REST *>(value) : nullptr;
  }
  ...
  GamePacket::SC_LEVEL_UP_NOTIT *AsSC_LEVEL_UP_NOTI() {
    return type == Packet_SC_LEVEL_UP_NOTI ?
      reinterpret_cast<GamePacket::SC_LEVEL_UP_NOTIT *>(value) : nullptr;
  }
...
struct SC_LOGIN_REST : public flatbuffers::NativeTable {
  ...
  std::unique_ptr<Info::ObjectInfoWithPosT> object_info_with_pos{};
...
struct SC_LOGIN_RES FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const Info::ObjectInfoWithPos *object_info_with_pos() const {
    return GetPointer<const Info::ObjectInfoWithPos *>(VT_OBJECT_INFO_WITH_POS);
  }
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_OBJECT_INFO_WITH_POS) &&
           verifier.VerifyTable(object_info_with_pos()) &&
...
struct SC_LOGIN_RESBuilder {
  ...
  void add_object_info_with_pos(flatbuffers::Offset<Info::ObjectInfoWithPos> object_info_with_pos) {
    fbb_.AddOffset(SC_LOGIN_RES::VT_OBJECT_INFO_WITH_POS, object_info_with_pos);
  }
...
inline flatbuffers::Offset<SC_LOGIN_RES> CreateSC_LOGIN_RES(
    flatbuffers::FlatBufferBuilder &_fbb,
    GamePacket::ErrorCode result = GamePacket::ErrorCode_SUCCESS,
    flatbuffers::Offset<Info::ObjectInfoWithPos> object_info_with_pos = 0,
  ...
  builder_.add_object_info_with_pos(object_info_with_pos);
...
struct SC_ITEM_INVENTORY_INFO_NOTIT : public flatbuffers::NativeTable {
  typedef SC_ITEM_INVENTORY_INFO_NOTI TableType;
  uint8_t max_slot_count = 0;
  std::vector<std::unique_ptr<Info::ItemSlotInfoT>> item_slot_info{};
};

struct SC_ITEM_INVENTORY_INFO_NOTI FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  typedef SC_ITEM_INVENTORY_INFO_NOTIT NativeTableType;
  typedef SC_ITEM_INVENTORY_INFO_NOTIBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_MAX_SLOT_COUNT = 4,
    VT_ITEM_SLOT_INFO = 6
  };
  ...
  SC_ITEM_INVENTORY_INFO_NOTIT *UnPack(const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  void UnPackTo(SC_ITEM_INVENTORY_INFO_NOTIT *_o, const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  static flatbuffers::Offset<SC_ITEM_INVENTORY_INFO_NOTI> Pack(flatbuffers::FlatBufferBuilder &_fbb, const SC_ITEM_INVENTORY_INFO_NOTIT* _o, const flatbuffers::rehasher_function_t *_rehasher = nullptr);
};

struct SC_ITEM_INVENTORY_INFO_NOTIBuilder {
  typedef SC_ITEM_INVENTORY_INFO_NOTI Table;
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_max_slot_count(uint8_t max_slot_count) {
    fbb_.AddElement<uint8_t>(SC_ITEM_INVENTORY_INFO_NOTI::VT_MAX_SLOT_COUNT, max_slot_count, 0);
  }
  void add_item_slot_info(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<Info::ItemSlotInfo>>> item_slot_info) {
    fbb_.AddOffset(SC_ITEM_INVENTORY_INFO_NOTI::VT_ITEM_SLOT_INFO, item_slot_info);
  }
  explicit SC_ITEM_INVENTORY_INFO_NOTIBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  flatbuffers::Offset<SC_ITEM_INVENTORY_INFO_NOTI> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = flatbuffers::Offset<SC_ITEM_INVENTORY_INFO_NOTI>(end);
    return o;
  }
};

inline flatbuffers::Offset<SC_ITEM_INVENTORY_INFO_NOTI> CreateSC_ITEM_INVENTORY_INFO_NOTI(
    flatbuffers::FlatBufferBuilder &_fbb,
    uint8_t max_slot_count = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<Info::ItemSlotInfo>>> item_slot_info = 0) {
  SC_ITEM_INVENTORY_INFO_NOTIBuilder builder_(_fbb);
  builder_.add_item_slot_info(item_slot_info);
  builder_.add_max_slot_count(max_slot_count);
  return builder_.Finish();
}

inline flatbuffers::Offset<SC_ITEM_INVENTORY_INFO_NOTI> CreateSC_ITEM_INVENTORY_INFO_NOTIDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    uint8_t max_slot_count = 0,
  ...
  return GamePacket::CreateSC_ITEM_INVENTORY_INFO_NOTI(
      _fbb,
      max_slot_count,
      item_slot_info__);
}

flatbuffers::Offset<SC_ITEM_INVENTORY_INFO_NOTI> CreateSC_ITEM_INVENTORY_INFO_NOTI(flatbuffers::FlatBufferBuilder &_fbb, const SC_ITEM_INVENTORY_INFO_NOTIT *_o, const flatbuffers::rehasher_function_t *_rehasher = nullptr);
...
struct SC_SPAWN_PLAYER_NOTIBuilder {
  ...
  flatbuffers::uoffset_t start_;
  void add_object_info_with_pos(flatbuffers::Offset<Info::ObjectInfoWithPos> object_info_with_pos) {
    fbb_.AddOffset(SC_SPAWN_PLAYER_NOTI::VT_OBJECT_INFO_WITH_POS, object_info_with_pos);
  }
  void add_creature_info(flatbuffers::Offset<Info::CreatureInfo> creature_info) {
...
struct SC_DESPAWN_OBJECT_NOTIBuilder {
  ...
  void add_object_info(const Info::ObjectInfo *object_info) {
    fbb_.AddStruct(SC_DESPAWN_OBJECT_NOTI::VT_OBJECT_INFO, object_info);
  }
...
struct SC_MOVE_RESBuilder {
  ...
  flatbuffers::uoffset_t start_;
  void add_object_info_with_pos(flatbuffers::Offset<Info::ObjectInfoWithPos> object_info_with_pos) {
    fbb_.AddOffset(SC_MOVE_RES::VT_OBJECT_INFO_WITH_POS, object_info_with_pos);
  }
...
struct SC_SET_STATE_RESBuilder {
  ...
  flatbuffers::uoffset_t start_;
  void add_object_info(const Info::ObjectInfo *object_info) {
    fbb_.AddStruct(SC_SET_STATE_RES::VT_OBJECT_INFO, object_info);
  }
  void add_state(Define::ObjectState state) {
...
struct SC_USE_SKILL_RESBuilder {
  ...
  flatbuffers::uoffset_t start_;
  void add_object_info(const Info::ObjectInfo *object_info) {
    fbb_.AddStruct(SC_USE_SKILL_RES::VT_OBJECT_INFO, object_info);
  }
  void add_skill_id(int32_t skill_id) {
...
struct DamageInfoBuilder {
  ...
  flatbuffers::uoffset_t start_;
  void add_object_info(const Info::ObjectInfo *object_info) {
    fbb_.AddStruct(DamageInfo::VT_OBJECT_INFO, object_info);
  }
...
struct SC_REVIVE_RESBuilder {
  ...
  flatbuffers::uoffset_t start_;
  void add_object_info_with_pos(flatbuffers::Offset<Info::ObjectInfoWithPos> object_info_with_pos) {
    fbb_.AddOffset(SC_REVIVE_RES::VT_OBJECT_INFO_WITH_POS, object_info_with_pos);
  }
...
struct SC_SPAWN_PROJECTILE_NOTIBuilder {
  ...
  flatbuffers::uoffset_t start_;
  void add_object_info_with_pos(flatbuffers::Offset<Info::ObjectInfoWithPos> object_info_with_pos) {
    fbb_.AddOffset(SC_SPAWN_PROJECTILE_NOTI::VT_OBJECT_INFO_WITH_POS, object_info_with_pos);
  }
...
struct CS_EQUIP_GEAR_REQT : public flatbuffers::NativeTable {
  typedef CS_EQUIP_GEAR_REQ TableType;
  int64_t item_uid = 0;
};

struct CS_EQUIP_GEAR_REQ FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  typedef CS_EQUIP_GEAR_REQT NativeTableType;
  typedef CS_EQUIP_GEAR_REQBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_ITEM_UID = 4
  };
  ...
  CS_EQUIP_GEAR_REQT *UnPack(const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  void UnPackTo(CS_EQUIP_GEAR_REQT *_o, const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  static flatbuffers::Offset<CS_EQUIP_GEAR_REQ> Pack(flatbuffers::FlatBufferBuilder &_fbb, const CS_EQUIP_GEAR_REQT* _o, const flatbuffers::rehasher_function_t *_rehasher = nullptr);
};

struct CS_EQUIP_GEAR_REQBuilder {
  typedef CS_EQUIP_GEAR_REQ Table;
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_item_uid(int64_t item_uid) {
    fbb_.AddElement<int64_t>(CS_EQUIP_GEAR_REQ::VT_ITEM_UID, item_uid, 0);
  }
  explicit CS_EQUIP_GEAR_REQBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  flatbuffers::Offset<CS_EQUIP_GEAR_REQ> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = flatbuffers::Offset<CS_EQUIP_GEAR_REQ>(end);
    return o;
  }
};

inline flatbuffers::Offset<CS_EQUIP_GEAR_REQ> CreateCS_EQUIP_GEAR_REQ(
    flatbuffers::FlatBufferBuilder &_fbb,
    int64_t item_uid = 0) {
  CS_EQUIP_GEAR_REQBuilder builder_(_fbb);
  builder_.add_item_uid(item_uid);
  return builder_.Finish();
}

flatbuffers::Offset<CS_EQUIP_GEAR_REQ> CreateCS_EQUIP_GEAR_REQ(flatbuffers::FlatBufferBuilder &_fbb, const CS_EQUIP_GEAR_REQT *_o, const flatbuffers::rehasher_function_t *_rehasher = nullptr);

struct SC_EQUIP_GEAR_REST : public flatbuffers::NativeTable {
  typedef SC_EQUIP_GEAR_RES TableType;
  GamePacket::ErrorCode result = GamePacket::ErrorCode_SUCCESS;
  int64_t item_uid = 0;
};

struct SC_EQUIP_GEAR_RES FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  typedef SC_EQUIP_GEAR_REST NativeTableType;
  typedef SC_EQUIP_GEAR_RESBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_RESULT = 4,
    VT_ITEM_UID = 6
  };
  ...
  SC_EQUIP_GEAR_REST *UnPack(const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  void UnPackTo(SC_EQUIP_GEAR_REST *_o, const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  static flatbuffers::Offset<SC_EQUIP_GEAR_RES> Pack(flatbuffers::FlatBufferBuilder &_fbb, const SC_EQUIP_GEAR_REST* _o, const flatbuffers::rehasher_function_t *_rehasher = nullptr);
};

struct SC_EQUIP_GEAR_RESBuilder {
  typedef SC_EQUIP_GEAR_RES Table;
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_result(GamePacket::ErrorCode result) {
    fbb_.AddElement<int8_t>(SC_EQUIP_GEAR_RES::VT_RESULT, static_cast<int8_t>(result), 0);
  }
  void add_item_uid(int64_t item_uid) {
    fbb_.AddElement<int64_t>(SC_EQUIP_GEAR_RES::VT_ITEM_UID, item_uid, 0);
  }
  explicit SC_EQUIP_GEAR_RESBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  flatbuffers::Offset<SC_EQUIP_GEAR_RES> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = flatbuffers::Offset<SC_EQUIP_GEAR_RES>(end);
    return o;
  }
};

inline flatbuffers::Offset<SC_EQUIP_GEAR_RES> CreateSC_EQUIP_GEAR_RES(
    flatbuffers::FlatBufferBuilder &_fbb,
    GamePacket::ErrorCode result = GamePacket::ErrorCode_SUCCESS,
    int64_t item_uid = 0) {
  SC_EQUIP_GEAR_RESBuilder builder_(_fbb);
  builder_.add_item_uid(item_uid);
  builder_.add_result(result);
  return builder_.Finish();
}

flatbuffers::Offset<SC_EQUIP_GEAR_RES> CreateSC_EQUIP_GEAR_RES(flatbuffers::FlatBufferBuilder &_fbb, const SC_EQUIP_GEAR_REST *_o, const flatbuffers::rehasher_function_t *_rehasher = nullptr);
...
struct SC_LEVEL_UP_NOTIT : public flatbuffers::NativeTable {
  typedef SC_LEVEL_UP_NOTI TableType;
  int64_t oid = 0;
};

struct SC_LEVEL_UP_NOTI FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  typedef SC_LEVEL_UP_NOTIT NativeTableType;
  typedef SC_LEVEL_UP_NOTIBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_OID = 4
  };
  int64_t oid() const {
  ...
  SC_LEVEL_UP_NOTIT *UnPack(const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  void UnPackTo(SC_LEVEL_UP_NOTIT *_o, const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  static flatbuffers::Offset<SC_LEVEL_UP_NOTI> Pack(flatbuffers::FlatBufferBuilder &_fbb, const SC_LEVEL_UP_NOTIT* _o, const flatbuffers::rehasher_function_t *_rehasher = nullptr);
};

struct SC_LEVEL_UP_NOTIBuilder {
  typedef SC_LEVEL_UP_NOTI Table;
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_oid(int64_t oid) {
    fbb_.AddElement<int64_t>(SC_LEVEL_UP_NOTI::VT_OID, oid, 0);
  }
  explicit SC_LEVEL_UP_NOTIBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  flatbuffers::Offset<SC_LEVEL_UP_NOTI> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = flatbuffers::Offset<SC_LEVEL_UP_NOTI>(end);
    return o;
  }
};

inline flatbuffers::Offset<SC_LEVEL_UP_NOTI> CreateSC_LEVEL_UP_NOTI(
    flatbuffers::FlatBufferBuilder &_fbb,
    int64_t oid = 0) {
  SC_LEVEL_UP_NOTIBuilder builder_(_fbb);
  builder_.add_oid(oid);
  return builder_.Finish();
}
...
struct Root FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const GamePacket::SC_ITEM_INVENTORY_INFO_NOTI *packet_as_SC_ITEM_INVENTORY_INFO_NOTI() const {
    return packet_type() == GamePacket::Packet_SC_ITEM_INVENTORY_INFO_NOTI ? static_cast<const GamePacket::SC_ITEM_INVENTORY_INFO_NOTI *>(packet()) : nullptr;
  }
  ...
  const GamePacket::CS_EQUIP_GEAR_REQ *packet_as_CS_EQUIP_GEAR_REQ() const {
    return packet_type() == GamePacket::Packet_CS_EQUIP_GEAR_REQ ? static_cast<const GamePacket::CS_EQUIP_GEAR_REQ *>(packet()) : nullptr;
  }
  const GamePacket::SC_EQUIP_GEAR_RES *packet_as_SC_EQUIP_GEAR_RES() const {
    return packet_type() == GamePacket::Packet_SC_EQUIP_GEAR_RES ? static_cast<const GamePacket::SC_EQUIP_GEAR_RES *>(packet()) : nullptr;
  }
...
template<> inline const GamePacket::SC_ITEM_INVENTORY_INFO_NOTI *Root::packet_as<GamePacket::SC_ITEM_INVENTORY_INFO_NOTI>() const {
  return packet_as_SC_ITEM_INVENTORY_INFO_NOTI();
}
...
template<> inline const GamePacket::CS_EQUIP_GEAR_REQ *Root::packet_as<GamePacket::CS_EQUIP_GEAR_REQ>() const {
  return packet_as_CS_EQUIP_GEAR_REQ();
}

template<> inline const GamePacket::SC_EQUIP_GEAR_RES *Root::packet_as<GamePacket::SC_EQUIP_GEAR_RES>() const {
  return packet_as_SC_EQUIP_GEAR_RES();
}
...
inline void SC_LOGIN_RES::UnPackTo(SC_LOGIN_REST *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = object_info_with_pos(); if (_e) _o->object_info_with_pos = std::unique_ptr<Info::ObjectInfoWithPosT>(_e->UnPack(_resolver)); }
...
inline flatbuffers::Offset<SC_LOGIN_RES> CreateSC_LOGIN_RES(flatbuffers::FlatBufferBuilder &_fbb, const SC_LOGIN_REST *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  auto _object_info_with_pos = _o->object_info_with_pos ? CreateObjectInfoWithPos(_fbb, _o->object_info_with_pos.get(), _rehasher) : 0;
...
inline SC_ITEM_INVENTORY_INFO_NOTIT *SC_ITEM_INVENTORY_INFO_NOTI::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  auto _o = std::unique_ptr<SC_ITEM_INVENTORY_INFO_NOTIT>(new SC_ITEM_INVENTORY_INFO_NOTIT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}

inline void SC_ITEM_INVENTORY_INFO_NOTI::UnPackTo(SC_ITEM_INVENTORY_INFO_NOTIT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
...
inline flatbuffers::Offset<SC_ITEM_INVENTORY_INFO_NOTI> SC_ITEM_INVENTORY_INFO_NOTI::Pack(flatbuffers::FlatBufferBuilder &_fbb, const SC_ITEM_INVENTORY_INFO_NOTIT* _o, const flatbuffers::rehasher_function_t *_rehasher) {
  return CreateSC_ITEM_INVENTORY_INFO_NOTI(_fbb, _o, _rehasher);
}

inline flatbuffers::Offset<SC_ITEM_INVENTORY_INFO_NOTI> CreateSC_ITEM_INVENTORY_INFO_NOTI(flatbuffers::FlatBufferBuilder &_fbb, const SC_ITEM_INVENTORY_INFO_NOTIT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const SC_ITEM_INVENTORY_INFO_NOTIT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline CS_EQUIP_GEAR_REQT *CS_EQUIP_GEAR_REQ::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  auto _o = std::unique_ptr<CS_EQUIP_GEAR_REQT>(new CS_EQUIP_GEAR_REQT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}

inline void CS_EQUIP_GEAR_REQ::UnPackTo(CS_EQUIP_GEAR_REQT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = item_uid(); _o->item_uid = _e; }
}

inline flatbuffers::Offset<CS_EQUIP_GEAR_REQ> CS_EQUIP_GEAR_REQ::Pack(flatbuffers::FlatBufferBuilder &_fbb, const CS_EQUIP_GEAR_REQT* _o, const flatbuffers::rehasher_function_t *_rehasher) {
  return CreateCS_EQUIP_GEAR_REQ(_fbb, _o, _rehasher);
}

inline flatbuffers::Offset<CS_EQUIP_GEAR_REQ> CreateCS_EQUIP_GEAR_REQ(flatbuffers::FlatBufferBuilder &_fbb, const CS_EQUIP_GEAR_REQT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const CS_EQUIP_GEAR_REQT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _item_uid = _o->item_uid;
  return GamePacket::CreateCS_EQUIP_GEAR_REQ(
      _fbb,
      _item_uid);
}

inline SC_EQUIP_GEAR_REST *SC_EQUIP_GEAR_RES::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  auto _o = std::unique_ptr<SC_EQUIP_GEAR_REST>(new SC_EQUIP_GEAR_REST());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}

inline void SC_EQUIP_GEAR_RES::UnPackTo(SC_EQUIP_GEAR_REST *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = result(); _o->result = _e; }
  { auto _e = item_uid(); _o->item_uid = _e; }
...
inline flatbuffers::Offset<SC_EQUIP_GEAR_RES> SC_EQUIP_GEAR_RES::Pack(flatbuffers::FlatBufferBuilder &_fbb, const SC_EQUIP_GEAR_REST* _o, const flatbuffers::rehasher_function_t *_rehasher) {
  return CreateSC_EQUIP_GEAR_RES(_fbb, _o, _rehasher);
}

inline flatbuffers::Offset<SC_EQUIP_GEAR_RES> CreateSC_EQUIP_GEAR_RES(flatbuffers::FlatBufferBuilder &_fbb, const SC_EQUIP_GEAR_REST *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const SC_EQUIP_GEAR_REST* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _result = _o->result;
  auto _item_uid = _o->item_uid;
  return GamePacket::CreateSC_EQUIP_GEAR_RES(
      _fbb,
      _result,
      _item_uid);
}
...
inline SC_LEVEL_UP_NOTIT *SC_LEVEL_UP_NOTI::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  auto _o = std::unique_ptr<SC_LEVEL_UP_NOTIT>(new SC_LEVEL_UP_NOTIT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}

inline void SC_LEVEL_UP_NOTI::UnPackTo(SC_LEVEL_UP_NOTIT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = oid(); _o->oid = _e; }
}

inline flatbuffers::Offset<SC_LEVEL_UP_NOTI> SC_LEVEL_UP_NOTI::Pack(flatbuffers::FlatBufferBuilder &_fbb, const SC_LEVEL_UP_NOTIT* _o, const flatbuffers::rehasher_function_t *_rehasher) {
  return CreateSC_LEVEL_UP_NOTI(_fbb, _o, _rehasher);
}

inline flatbuffers::Offset<SC_LEVEL_UP_NOTI> CreateSC_LEVEL_UP_NOTI(flatbuffers::FlatBufferBuilder &_fbb, const SC_LEVEL_UP_NOTIT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const SC_LEVEL_UP_NOTIT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _oid = _o->oid;
  return GamePacket::CreateSC_LEVEL_UP_NOTI(
      _fbb,
      _oid);
}
...
inline bool VerifyPacket(flatbuffers::Verifier &verifier, const void *obj, Packet type) {
  switch (type) {
    ...
    case Packet_SC_ITEM_INVENTORY_INFO_NOTI: {
      auto ptr = reinterpret_cast<const GamePacket::SC_ITEM_INVENTORY_INFO_NOTI *>(obj);
      return verifier.VerifyTable(ptr);
    }
    ...
    case Packet_CS_EQUIP_GEAR_REQ: {
      auto ptr = reinterpret_cast<const GamePacket::CS_EQUIP_GEAR_REQ *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Packet_SC_EQUIP_GEAR_RES: {
      auto ptr = reinterpret_cast<const GamePacket::SC_EQUIP_GEAR_RES *>(obj);
      return verifier.VerifyTable(ptr);
    }
...
inline flatbuffers::Offset<void> PacketUnion::Pack(flatbuffers::FlatBufferBuilder &_fbb, const flatbuffers::rehasher_function_t *_rehasher) const {
  switch (type) {
    ...
    case Packet_SC_ITEM_INVENTORY_INFO_NOTI: {
      auto ptr = reinterpret_cast<const GamePacket::SC_ITEM_INVENTORY_INFO_NOTIT *>(value);
      return CreateSC_ITEM_INVENTORY_INFO_NOTI(_fbb, ptr, _rehasher).Union();
    }
    case Packet_SC_PING_REQ: {
    ...
    case Packet_CS_EQUIP_GEAR_REQ: {
      auto ptr = reinterpret_cast<const GamePacket::CS_EQUIP_GEAR_REQT *>(value);
      return CreateCS_EQUIP_GEAR_REQ(_fbb, ptr, _rehasher).Union();
    }
    case Packet_SC_EQUIP_GEAR_RES: {
      auto ptr = reinterpret_cast<const GamePacket::SC_EQUIP_GEAR_REST *>(value);
      return CreateSC_EQUIP_GEAR_RES(_fbb, ptr, _rehasher).Union();
    }
    case Packet_CS_UNEQUIP_GEAR_REQ: {
...
inline PacketUnion::PacketUnion(const PacketUnion &u) : type(u.type), value(nullptr) {
  switch (type) {
    ...
    case Packet_SC_ITEM_INVENTORY_INFO_NOTI: {
      FLATBUFFERS_ASSERT(false);  // GamePacket::SC_ITEM_INVENTORY_INFO_NOTIT not copyable.
      break;
    }
    case Packet_SC_PING_REQ: {
    ...
    case Packet_CS_EQUIP_GEAR_REQ: {
      value = new GamePacket::CS_EQUIP_GEAR_REQT(*reinterpret_cast<GamePacket::CS_EQUIP_GEAR_REQT *>(u.value));
      break;
    }
    case Packet_SC_EQUIP_GEAR_RES: {
      value = new GamePacket::SC_EQUIP_GEAR_REST(*reinterpret_cast<GamePacket::SC_EQUIP_GEAR_REST *>(u.value));
      break;
    }
    case Packet_CS_UNEQUIP_GEAR_REQ: {
...
inline void PacketUnion::Reset() {
  switch (type) {
    ...
    case Packet_SC_ITEM_INVENTORY_INFO_NOTI: {
      auto ptr = reinterpret_cast<GamePacket::SC_ITEM_INVENTORY_INFO_NOTIT *>(value);
      delete ptr;
      break;
    }
    case Packet_SC_PING_REQ: {
    ...
    case Packet_CS_EQUIP_GEAR_REQ: {
      auto ptr = reinterpret_cast<GamePacket::CS_EQUIP_GEAR_REQT *>(value);
      delete ptr;
      break;
    }
    case Packet_SC_EQUIP_GEAR_RES: {
      auto ptr = reinterpret_cast<GamePacket::SC_EQUIP_GEAR_REST *>(value);
      delete ptr;
      break;
    }
    case Packet_CS_UNEQUIP_GEAR_REQ: {
